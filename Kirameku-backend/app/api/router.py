...
from app.api.acg import router as acg_router
from app.api.secret_codes import router as secret_codes_router
...
api_router.include_router(acg_router)
api_router.include_router(secret_codes_router)
